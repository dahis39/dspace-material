...
<%!
    		...
    		Map collectionMap, Map subcommunityMap) throws ItemCountException, IOException, SQLException
    {
        ...
        out.println( "<li class=\"media well well-lg \">" );
        ...
        out.println( "<div class=\"media-body\"><h2 class=\"media-heading\"><a href=\"" + request.getContextPath() + "/handle/"
        ...
        if (cols != null && cols.size() > 0)
        {
            ...
            for (int j = 0; j < cols.size(); j++)
            {
                ...
                out.println("<div class=\"media-body\"><h3 class=\"media-heading\"><a href=\"" + request.getContextPath() + "/handle/" + cols.get(j).getHandle() + "\">" + cols.get(j).getName() +"</a>");
				if(ConfigurationManager.getBooleanProperty("webui.strengths.show"))
                {
