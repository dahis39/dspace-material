...
<%
	...
	<div class="col-md-12">
        ...
        <div id="recent-submissions-carousel" class="panel-heading carousel slide comm-home-recent-submissions-carousel">
...
%>
    <a href="<%= request.getContextPath() %>/feed/<%= fmts[j] %>/<%= community.getHandle() %>"><img src="<%= request.getContextPath() %>/image/<%= icon %>" alt="RSS Feed" width="<%= width %>" /></a>
<%
    	}
    }
%>
	...
	<%	for (int i = 0; i < items.size(); i++)
		{
		    ...
		    <div style="padding-bottom: 50px; min-height: 200px;" class="item <%= first?"active":""%>">
		      <div style="padding-left: 80px; padding-right: 80px; width: 100%;  display: inline-block;"><%= StringUtils.abbreviate(displayTitle, 400) %>
		      	<a href="<%= request.getContextPath() %>/handle/<%=items.get(i).getHandle() %>"
				   class="btn btn-xs btn-raised btn-primary">See</a>
		      </div>
		    </div>
<%
				first = false;
...
<div class="panel panel-primary">
	...
	<div class="panel-body btn-group btn-group-justified btn-group-raised">
